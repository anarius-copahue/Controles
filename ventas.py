...
FARMACIA_POR_USUARIO = {
    "KMACIAS" : ["DUTY PAID","LA FRANCO","FARMACITY","FARMAPLUS"],
    ...
    "AFLEBA" : ["FARMASHOP","ZENTNER","FARMAVIP"],
    "YCUEZZO" : ["BRADEL DEL PUEBLO","SAN FRANCISCO SALTA"],
    "YARRECHE" : ["ZORICH","SOY TU FARMACIA","PUNTO DE SALUD","FARMACIA MANES","VIDELA","FARMACIA BELEN""CENTRAL OESTE",
                  "FARMATODO","SELMA","TKL","UOMAX","SARTI","FARMA24","FARMAFE"],
    "EVEIGA" : ["RIADIGOS"],
    "JANDERMARCH" : [ ],
    "NBRIDI": ["TKL"]
}
